...
export const ES: SiteText = {
  ...
  alt: {
    headerLogo: 'Logo de Chiquis',
    fullLogo: 'Logo a Todo Color de Chiquis',
    storeFront: 'Tienda Chiquis Nutrition',
    foodPhoto: 'Comida',
    beveragePhoto: 'Bebida',
    supplement: 'Suplemento',
    vitamins: 'Vitaminas',
    herbalifePack: 'Paquete de Prueba Herbalife',
    zumbaTeacher: 'Instructora de Zumba',
    usaFlag: 'Bandera de EE.UU. - Inglés',
    spainFlag: 'Bandera de España - Español',
  },
  aria: {
