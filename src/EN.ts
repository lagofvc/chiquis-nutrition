...
export const EN: SiteText = {
  ...
  alt: {
    headerLogo: "Chiqui's Logo",
    fullLogo: 'Chiquis Full Color Logo',
    storeFront: 'Chiquis Nutrition Store',
    foodPhoto: 'Food',
    beveragePhoto: 'Beverage',
    supplement: 'Supplement',
    vitamins: 'Vitamins',
    herbalifePack: 'Herbalife Trial Pack',
    zumbaTeacher: 'Zumba Teacher',
    usaFlag: 'USA Flag - English',
    spainFlag: 'Spain Flag - Spanish',
  },
  aria: {
